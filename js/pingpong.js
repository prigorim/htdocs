...
$(function () {
    ...
    function stop_the_game() {
        ...
        game_over = true;
        if (who_won == 2) {
            restart_btn.html('<span><font color="#dff3ff">Blue win</font></span><br><br><span id="winner">Restart</span>').show();
        }
        else {
            restart_btn.html('<span><font color="#addfad">Green win</font></span><br><br><span id="winner">Restart</span>').show();
        }
